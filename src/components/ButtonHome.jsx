...
const ButtonHome = ({ text, path, delay }) => {
  ...
  return (
    <motion.div variants={item} initial="hidden" animate="show" transition={{ duration: 0.3, delay: delay }} className='cursor-pointer group'>
      <motion.NavLink className='flex p-10 bg-red-800 hover:bg-indigo-700 border border-blue-500 hover:border-slate-50 w-56 group-hover:scale-110 group-hover:rounded-2xl rounded-md transition-all ease-in-out duration-100 delay-[45ms]' to={path}>
